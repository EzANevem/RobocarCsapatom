...
int main ( int argc, char* argv[] )
{
     ...
     if ( vm.count ( "version" ) ) {
          std::cout << "Robocar City Emulator and Robocar World Championship, IHaveNoIdea team SHM Client" << std::endl
                    ...
                    << "IHaveNoIdea is the BEST!" << std::endl;
          return 0;
     }
     ...
     if ( vm.count ( "team" ) )
       ...
       team.assign ( "IHaveNoIdea" );
     
     // If you use this sample you should add your copyright information here too:
     
     std::cout << "IHaveNoIdea team SHM Client" << std::endl
     << "This SHM Client program has been modified by Ármin Veress" << std::endl
     << "Copyright (C) 2014, 2015 Norbert Bátfai" << std::endl
     << "License GPLv3+: GNU GPL version 3 or later <http://gnu.org/licenses/gpl.html>" << std::endl
     << "Team home page <https://github.com/EzANevem/RobocarCsapatom/>" << std::endl
     << "\n" << std::endl;
